    ...
    inquirer.prompt([
        {
            ...
            choices: ['twitter', 'spotify', 'movies', 'random', 'quit']
        }
    ]).then(function (answers) {
        console.log(answers.runName);
        switch (answers.runName) {
            case 'twitter':
                getTwitter();
                break;
            case 'spotify':
                inquirer.prompt([
                    ...
                    getSpotify(songAnswer.songTrack);
                })
                break;
            case 'movies':
                inquirer.prompt([
                    ...
                    process.argv[3] = movieAnswer.movieName;
                    getMovie();
                })
                break;
            case 'random':
